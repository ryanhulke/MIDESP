...
public class MICalculator {
	...
	public static double calcMI_DiscPheno(Phenotype phenotype, SNP... snps) {
		...
		double normFactor;
		switch (snps.length) {
			case 1 -> normFactor = singleSNPNormFactor;
			case 2 -> normFactor = snpPairNormFactor;
			default -> throw new IllegalArgumentException("Invalid number of SNPs for MI calculation");
		}
		//Prepare variables
